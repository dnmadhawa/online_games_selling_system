...
public class GameInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*get the parameters for insert the details*/	
		...
		isTrue = GameDBUtil.insertgame(Gamename, DeveloperID,create_date, Genre, platform, price, description);
		
	
        if(isTrue == true) {
			
			out.println("<script type='text/javascript'>");
			out.println("alert('Game Inserted');");
