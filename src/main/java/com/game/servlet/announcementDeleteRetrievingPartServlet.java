...
@WebServlet("/announcementDeleteRetrievingPartServlet")
public class announcementDeleteRetrievingPartServlet extends HttpServlet {
    ...
    String announcementID = request.getParameter("announcementID");
		...
		RequestDispatcher dis = request.getRequestDispatcher("viewToDeleteAnnouncement.jsp");
